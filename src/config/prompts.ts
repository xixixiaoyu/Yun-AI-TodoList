const commonStudyText = `我希望通过不断思考并回答你提出的问题来学习知识。我们的对话流程是这样的：
                        1. 我向你提出我想了解的问题。
                        2. 你一步步思考我的问题后给出通俗易懂、自然流畅的最佳回答，可以使用类比或实际例子来帮助我理解，如果解释问题需要必须知道的前置知识，请讲解这些前置知识。
                        3. 然后你围绕我给出的问题，再提出一些相关的具体且重要的问题，检验我是否完全理解。
                        4. 如果你发现我回答问题有理解不清的地方，请指出来，并根据我的反馈调整解释的难度或提供更多例子帮助理解。
